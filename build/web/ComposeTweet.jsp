                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center justify-content-between no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <h1 style="color:white"><a href="composeTweet.jsp">TWITTER
                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            <div class="title_text">
                                <h1 style="color: white">ComposeTweets <br></h1>
                                <form action="UserLogin" method="post">
                                    <div class="">
                                        <div class="form-group">
		        		
		    				
                                                <strong>User</strong>:&nbsp;<input type="text" name="user" placeholder="User ID" required  pattern="[A-Za-z]+" title="Name should not contain integer value">
                                        </div>
                                        <div class="form-group">
                                            <strong>Tweet</strong>:&nbsp;<textarea rows="4" cols="50">
                                                </textarea>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <strong>Image</strong>:&nbsp<input type="File" name="image" placeholder="Country" required  title="Please select a file">
                                        </div>
                                        <div class="form-group">		
