                                ...
                                <div class="title_text">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            String sqlQuery = "select *from tweets where usremail != '" + email + "'";
                                            ...
                                            while (rs.next()) {
                                                sno++;
                                                String all_emails = rs.getString("usremail");
                                                int all_id = uu.getUserId(all_emails);
                                                String all_name = uu.getUserName(all_emails);
                                                String tweet_User = rs.getString("username");
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="UserFollowTweets.jsp?tweetid=<%=tweet_id%>&all_emails=<%=all_emails%>&all_name=<%=all_name%>" >Follow</a></td>
