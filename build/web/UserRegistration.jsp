                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center justify-content-between no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <h1 style="color:white"><a href="index.jsp">SPAMMER
                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            <div class="title_text">
                                <h1 style="color: white">User Register <br></h1>
                                <form action="userregisteraction" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <strong>UserName</strong>&nbsp;:&nbsp;&nbsp;<input type="text" name="Username" placeholder="Name" required  pattern="[A-Za-z]+" title="Name should not contain integer value">                                  </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                               <strong>PassWord</strong>&nbsp;&nbsp;:&nbsp;&nbsp;<input type="password" name="password" placeholder="PassWord" required pattern="(?=.*\d)(?=.*[a-z]).{8,}" title="Must contain at least one number and lowercase letter, and at least 8 or more characters">
                                        </div>
                                        <div class="form-group">
			    		...
			    		<div class="form-group">
                                                ...
                                                <input type="File" name="Profile_img" placeholder="Country">
                                        </div>
			    		
                                                <div class="form-group">
                                                    <p class="mb-0"><input type="submit" value="submit"</p>
		    				</div>
                                        <%
