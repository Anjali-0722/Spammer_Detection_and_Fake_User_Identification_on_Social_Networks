                    ...
                    <div class="container-fluid p-0">
                        <div class="row align-items-center justify-content-between no-gutters">
                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a class="nav-item" href="UserProfileView.jsp">Profile</a></li>
                                            <li><a href="UserComposeTweet.jsp">ComposeTweet</a></li>
                                            <li><a href="UserTrending.jsp">Trending</a></li>
                                            <li><a href="UserFollowers.jsp">Followers</a></li>
                            ...
                            <div class="col-12">
                                ...
                                <h3>User Compose Tweets</h3>
                                <form action="UserComposeTweets" method="post" enctype="multipart/form-data">
                                    <div class="">
                                        <div class="form-group">
                                            <strong>User Name</strong>:&nbsp;<input type="text" name="user" value="<%=usrName%>" placeholder="User ID" required  pattern="[A-Za-z]+" title="Name should not contain integer value">
                                        </div>
                                        <input type="hidden" name="usremail" value="<%=email%>" >
                                        <div class="form-group">
                                            <strong>Tweet</strong>:&nbsp;<textarea name="tweet" id="field" onkeyup="countChar(this)" rows="5" cols="40"></textarea>
                                            <div id="charNum"></div>
                                        </div>
                                        <div class="form-group">
                                            <strong>Select Image</strong>:&nbsp
                                        </div>
                                        <input type="file" name="bpo">
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="form-group">		
                                    ...
                                    <!--<div class="form-group">
                                        ...
                                        if (msg != null && msg.equalsIgnoreCase("success")) {
                                            out.println("<font color='green'>Tweets uploaded sucessfully</font>");
                                        } else if (msg != null && msg.equalsIgnoreCase("failed")) {
                                            out.println("<font color='RED'>Tweets uploaded failed</font>");
                                        }
