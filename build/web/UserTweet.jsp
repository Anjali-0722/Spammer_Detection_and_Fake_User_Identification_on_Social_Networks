                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center justify-content-between no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <h1 style="color:white"><a href="AdminLogin.jsp">TWITTER
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="nav-item" href="UserTweet.jsp">UserTweet</a></li>
                            ...
                            <div class="col-xl-10">
                                <div class="title_text">
                                    <center> <table border="2" width="1" cellspacing="1" cellpadding="1">
                                            ...
                                            <center><h1 class="mb-4"style="color:white">  User Tweeted Details </h1></center>
