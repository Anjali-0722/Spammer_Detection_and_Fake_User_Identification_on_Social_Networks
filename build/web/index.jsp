                    ...
                    <div class="row align-items-center justify-content-between no-gutters">
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a class="nav-item" href="index.jsp">Home</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            <div class="title_text">
                                <h1 style="color: white"><dfn> Spammer Detection and Fake User Identification on Social Networks</dfn> <br><br></h1><br>
                                <div>
                                    <h2 style="color: white"> ABSTRACT:</h2>
                                </div>
                                 <div align="justify"><h1<p class="mb-4" style="color: white"> Social networking sites engage millions of users around the world. The users' interactions with
...
presented that classies the techniques based on their ability to detect: (i) fake content, (ii) spam based on
...
We are hopeful that the presented study will be a useful resource for researchers to nd the highlights of
recent developments in Twitter spam detection on a single platform.</p></div>
