                                    ...
                                    <table border="1">
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                String sqlQ = "select *from userregister where email =?";
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>User Name</td>
                                                <td><input type="text" name="username" value="<%=rs.getString("name")%>" ></td>
                                            </tr>
                                            <tr>
                                                <td>User Email</td>
                                            ...
                                            <tr>
                                                <td>Date of Birth</td>
                                                <td><input type="text" name="dob" value="<%=rs.getDate("dob")%>" readonly=""></td>
                                            </tr>
                                            
                                           
                                            <tr>
                                                <td>Profile Pic</td>
                                                <td><img src="GetProfilePic.jsp?id=<%=id%>" width="300" height="200"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>Country Name</td>
                                                <td><input type="text" name="country" value="<%=rs.getString("country")%>"  required=""></td>
                                            </tr>
                                            <tr>
                                                <td></td>
