                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a  class="nav-item" href="UserTrending.jsp">Trending</a></li>
                                ...
                                <div class="title_text">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            String sqlQuery = "SELECT username,useremail,tweetid,creatorname,creatoremail, COUNT(*) AS magnitude FROM tweetfollow  GROUP BY tweetid  ORDER BY magnitude DESC";
                                            ...
                                            while (rs.next()) {
                                                ...
                                                int usrID = uu.getUserId(useremail);
                                                ...
                                                int createrID = uu.getUserId(creatoremail);
                                                int count = rs.getInt("magnitude");
                                    ...
                                    <tr>
                                        ...
                                        <td><%=sno%></td>
                                        <td> <%=creatorname%></td>
                                        <td><img src="GetProfilePic.jsp?id=<%=createrID%>" width="120" height="120"></td>
                                        <td><%=creatoremail%></td>
                                        <td><%=tweet_id%></td>
                                        <td><%=tweet%></td>                                        
